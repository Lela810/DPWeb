...
// If running in the Vercel serverless environment we must not call listen()
if (!process.env.VERCEL) {
  app.listen(3000);
  console.log("App running on http://localhost:3000");
}

// Export the express app so serverless platforms (Vercel) can import and handle requests.
export default app;
